...
public final class UUID implements Serializable, Comparable<Object> {
    private static final long serialVersionUID = -3597318421464651238L;
    ...
    public String toString() {
        return (new StringBuffer()).append(digits(mostSigBits >> 32, 8)).append(digits(mostSigBits >> 16, 4))
                .append(digits(mostSigBits, 4)).append(digits(leastSigBits >> 48, 4)).append(digits(leastSigBits, 12)).toString();
    }
    ...
    public int compareTo(UUID uuid) {
        return mostSigBits >= uuid.mostSigBits
                ...
                ? leastSigBits >= uuid.leastSigBits ? ((byte) (((byte) (leastSigBits <= uuid.leastSigBits ? 0 : 1)))) : -1
                : 1
                : -1;
    }
